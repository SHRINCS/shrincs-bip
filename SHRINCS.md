...
|-|-|-|
| Stateless | <!-- CONST START STATELESS_SIGN_COMPRESSIONS_AVG -->1707269<!-- CONST END STATELESS_SIGN_COMPRESSIONS_AVG --> | |
...
The stateless component is much harder for low-power signers to work with because its parameters are more-or-less fixed, and it requires about <!-- CONST START STATELESS_SIGN_COMPRESSIONS_AVG -->1707269<!-- CONST END STATELESS_SIGN_COMPRESSIONS_AVG --> SHA256 compressions to sign.
